 ...
 * Created by bazzoni
 */
public class PluginOperationException extends Exception {
    /**
     ...
     * @since 1.7
     */
    public PluginOperationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
